...
st.markdown("Enter the loan applicant details:")
...
dti = st.number_input("Debt-to-Income Ratio (%)", min_value=0.0, max_value=100.0, value=0.0)
ltv = st.number_input("Loan-to-Value Ratio (%)", min_value=0.0, max_value=100.0, value=0.0)
ocltv = st.number_input("Original Combined LTV (%)", min_value=0.0, max_value=100.0, value=0.0)
loan_term = st.number_input("Loan Term (months)", min_value=1, value=1)
mip = st.number_input("Mortgage Insurance Premium (MIP)", min_value=0.0, value=0.0)
